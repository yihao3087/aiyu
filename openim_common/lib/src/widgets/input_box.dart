...
class _InputBoxState extends State<InputBox> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color borderColor = hasError ? (widget.errorColor ?? Styles.c_FF381F) : (widget.borderColor ?? Styles.c_E8EAEF);
    return Container(
        ...
        children: [
          ...
          if (hasError)
            Padding(
              ...
              child: widget.errorText!.toText..style = Styles.ts_FF381F_12sp,
            ),
        ],
      ),
    );

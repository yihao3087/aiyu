...
class Urls {
  ...
  static final getGroupMembersInfo = "${Config.imApiUrl}/group/get_group_members_info";
  static String get groupMessageSearch => "${Config.chatTokenUrl}/group/message/search";
}

const Map<String, String> zh_CN = {
  ...
  "setLoginAccount": "设置您的登录用户名",
  "accountTooShort": "用户名不得少于四位数，请重新输入",
  "accountFormatHint": "账号只能包含字母、数字或下划线",
  "setLoginPassword": "设置您的登录密码",
  "accountAlreadyExists": "该账号已被注册",
  "forgetPassword": "忘记密码",
  ...
  "plsEnterYourNickname": "请输入昵称",
  "setExclusiveNickname": "设置您的中文昵称",
  "loading": "加载中...",
  "setAvatar": "设置头像",
  "setInfo": "设置信息",
  ...
  'markHasRead': '标记已读',
  'delete': '删除',
  'deleteConversationHint': '确认删除该会话？',
  'nPieces': '%s条',
  "online": "在线",
  "offline": "离线",
  "phoneOnline": "手机",
  ...
  "toolboxCard": "名片",
  "toolboxFile": "文件",
  "fileTooLarge200": "文件大小超过200MB，无法发送",
  "toolboxLocation": "位置",
  ...
  "callDurationCaller": "通话时长 %s",
  "callDurationCallee": "对方已挂断，通话时长 %s",
  "cancelled": "已取消",
  "cancelledByCaller": "对方已取消",
  "rejectedByCaller": "对方已拒绝",
  "callTimeout": "超时无响应",
  "voiceCallConnecting": "正在连接...",
  "voiceCallCalling": "呼叫中...",
  "voiceCallIncoming": "来电中...",
  "voiceCallInProgress": "通话中",
  "voiceCallEnded": "通话已结束",
  "voiceCallRestoring": "正在恢复连接...",
  "voiceCallPoorNetwork": "网络不稳定",
  "voiceCallNetworkInterrupted": "网络中断",
  "voiceCallMute": "静音",
  "voiceCallUnmute": "取消静音",
  "voiceCallSpeaker": "免提",
  "voiceCallEarpiece": "听筒",
  "voiceCallLocalNetwork": "本机网络",
  "voiceCallRemoteNetwork": "对方网络",
  "voiceCallNetworkGood": "当前网络良好",
  "voiceCallNetworkNormal": "当前网络一般",
  "voiceCallNetworkPoor": "当前网络较差",
  "voiceCallNetworkDetecting": "正在检测网络...",
  "rejected": "已拒绝",
  "networkAnomaly": "网络异常",
  "dataAbnormal": "数据异常，请重试",
  "messageCannotRevoke": "该消息暂不支持全员撤回",
  'callMinimize': '最小化',
  ...
  'menuCopy': '复制',
  'menuDel': '删除',
  'deleteSuccessfully': '消息已删除',
  'menuForward': '转发',
  'menuReply': '回复',
  'menuMulti': '多选',
  'openWith': '打开方式',
  'selectMessages': '选择消息',
  'selectedMessageCount': '已选择（%s条）',
  'revokeForAll': '撤回（全员）',
  'menuRevoke': '撤回',
  'revokeSuccessfully': '消息已撤回',
  'menuAdd': '添加',
  'nMessage': '%s条新消息',
  'plsSelectLocation': '请选择一个位置',
  'getLocationFailed': '获取位置信息失败',
  'amapKeyMissing': '未配置高德地图Key，仅发送基础位置信息',
  ...
  "newGroupRequest": "群通知",
  "myFriend": "我的好友",
  "contactFriendEmpty": "暂无好友",
  "myGroup": "我的群组",
  "add": "添加",
  "addFriend": "添加好友",
  "addFriendHint": "通过ID号搜索添加",
  "createGroup": "创建群聊",
  "createGroupHint": "创建群聊，全面使用爱语",
  "addGroup": "添加群聊",
  ...
  'name': '姓名',
  'nickname': '昵称',
  'nicknameNeedChinese': '昵称至少包含一个中文字符',
  'gender': '性别',
  'englishName': '英文名',
  'birthDay': '生日',
  'tel': '座机',
  'mobile': '手机号码',
  'email': '邮箱',
  'pleaseSetAvatar': '请先设置头像',
  'clickToSelectAvatar': '点击选择头像',
  'man': '男',
  'woman': '女',
  'friendSetup': '好友设置',
  'setupRemark': '设置备注',
  ...
  "clearingMessages": "正在清空群聊...",
  "clearingCount": "已删除%s条消息",
  "languageSetup": "语言设置",
  "language": "语言",
  "english": "English",
  "chinese": "简体中文",
  ...
  "groupChatSetup": "群聊设置",
  "groupSearchChatHistory": "群聊内搜索",
  "groupSearchEnterKeyword": "请输入搜索关键字",
  "groupSearchNoResult": "暂无相关消息",
  "groupSearchResultWithKeyword": "找到%s条与“%s”相关的消息",
  "groupSearchResultWithoutKeyword": "共找到%s条消息",
  "groupSearchDateFilter": "按日期筛选",
  "groupSearchDateAll": "不限日期",
  ...
  'pleaseSelectMessage': '请先选择要删除的消息',
  'confirm': '确认',
  ...
  "calling": "通话中",
  "backgroundCallHint": "语音通话进行中",
  "backgroundCallWithName": "正在与%s进行语音通话",
  ...
  'gallery': '相册',
  'notification': '通知',
  'floatingWindowPermission': '悬浮窗权限',
  'floatingWindowPermissionHint': '请在系统设置中开启悬浮窗权限，以便通话时显示悬浮窗',

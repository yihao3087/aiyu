const Map<String, String> en_US = {
  ...
  "account": "Account",
  "plsEnterAccount": "Please enter account",
  "setLoginAccount": "Set your login username",
  "accountTooShort": "Username must be at least 4 characters. Please re-enter.",
  "accountFormatHint":
      "Account may contain letters, numbers or underscores only",
  "setLoginPassword": "Set your login password",
  ...
  "newUserRegister": "Welcome new users",
  ...
  "plsEnterYourNickname": "Please enter nickname",
  "setExclusiveNickname": "Set your Chinese nickname",
  "loading": "Loading...",
  "setAvatar": "Set your avatar",
  "avatarSet": "Set",
  "clickToSelectAvatar": "Tap to select avatar",
  "pleaseSetAvatar": "Please set your avatar first",
  "nicknameNeedChinese": "Nickname must contain at least one Chinese character",
  ...
  'delete': 'Delete',
  'deleteConversationHint': 'Delete this conversation?',
  'nPieces': '%s pieces',
  "online": "Online",
  "offline": "Offline",
  "phoneOnline": "Phone",
  ...
  "revokeSuccessfully": "Message revoked",
  "deleteSuccessfully": "Message deleted",
  "day": "day",
  "hour": "hour",
  "hours": "hours",
  "minute": "minute",
  ...
  "fileTooLarge200": "File size cannot exceed 200MB",
  "locationServiceDisabled": "Location services are disabled",
  "getLocationFailed": "Failed to get location",
  "amapKeyMissing": "AMap key is not configured. Sending basic location only.",
  "callDurationCaller": "Call duration %s",
  "callDurationCallee": "Peer hung up, call duration %s",
  "cancelled": "Cancelled",
  ...
  "voiceCallCalling": "Calling...",
  "voiceCallIncoming": "Incoming call...",
  "voiceCallInProgress": "In call",
  "voiceCallEnded": "Call ended",
  "voiceCallRestoring": "Restoring connection...",
  "voiceCallPoorNetwork": "Network is unstable",
  "voiceCallNetworkInterrupted": "Network disconnected",
  "voiceCallMute": "Mute",
  "voiceCallUnmute": "Unmute",
  "voiceCallSpeaker": "Speaker",
  "voiceCallEarpiece": "Earpiece",
  "voiceCallLocalNetwork": "My network",
  "voiceCallRemoteNetwork": "Peer network",
  "voiceCallNetworkGood": "Network is good",
  "voiceCallNetworkNormal": "Network is fair",
  "voiceCallNetworkPoor": "Network is poor",
  "voiceCallNetworkDetecting": "Checking network...",
  "rejected": "Rejected",
  "networkAnomaly": "Network Anomaly",
  "dataAbnormal": "Data is inconsistent, please retry.",
  "messageCannotRevoke": "This message cannot be revoked for everyone.",
  ...
  'selectedMessageCount': 'Selected (%s)',
  'revokeForAll': 'Revoke for All',
  'menuRevoke': 'Revoke',
  'menuAdd': 'Add',
  ...
  "myFriend": "My Friends",
  "contactFriendEmpty": "No friends yet",
  "myGroup": "My Groups",
  "add": "Add",
  "addFriend": "Add Friend",
  "addFriendHint": "Add by ID",
  "createGroup": "Create Group",
  "createGroupHint": "Create a group, fully utilize Yeliao",
  "addGroup": "Add Group",
  ...
  "clearingMessages": "Clearing group chat...",
  "clearingCount": "%s messages removed",
  ...
  "groupSearchChatHistory": "Search chat history",
  "groupSearchEnterKeyword": "Enter a keyword to search",
  "groupSearchNoResult": "No matching messages",
  "groupSearchResultWithKeyword": "Found %s messages containing \"%s\"",
  "groupSearchResultWithoutKeyword": "Found %s messages",
  "groupSearchDateFilter": "Filter by date",
  "groupSearchDateAll": "Any date",
  ...
  'pleaseSelectMessage': 'Select messages to delete',
  'confirm': 'Confirm',
  ...
  "busyLine": "The user is busy now",
  "waitingToAnswer": "Waiting to answer",
  "invitedYouToCall": "Invited you to a call",
  "calling": "Calling...",
  "backgroundCallHint": "Voice call in progress",
  "backgroundCallWithName": "Voice call with %s in progress",
  ...
  'floatingWindowPermission': 'Floating window',
  'floatingWindowPermissionHint':
      'Enable floating window permission in system settings to keep the call bubble available.',

...
class StrRes {
  ...
  static String get setLoginAccount => 'setLoginAccount'.tr;
  static String get accountTooShort => 'accountTooShort'.tr;
  ...
  static String get setExclusiveNickname => 'setExclusiveNickname'.tr;
  static String get setLoginPassword => 'setLoginPassword'.tr;
  static String get setAvatar => 'setAvatar'.tr;
  static String get accountAlreadyExists => 'accountAlreadyExists'.tr;
  static String get loading => 'loading'.tr;
  static String get avatarSet => 'avatarSet'.tr;
  static String get clickToSelectAvatar => 'clickToSelectAvatar'.tr;
  static String get pleaseSetAvatar => 'pleaseSetAvatar'.tr;
  static String get nicknameNeedChinese => 'nicknameNeedChinese'.tr;
  static String get takePhoto => 'takePhoto'.tr;
  static String get recordVideo => 'recordVideo'.tr;
  ...
  static String get richMedia => 'richMedia'.tr;
  ...
  static String get deleteConversationHint => 'deleteConversationHint'.tr;
  ...
  static String get callMinimize => 'callMinimize'.tr;
  ...
  static String get revokeSuccessfully => 'revokeSuccessfully'.tr;
  ...
  static String get fileTooLarge200 => 'fileTooLarge200'.tr;

  static String get locationServiceDisabled => 'locationServiceDisabled'.tr;

  static String get getLocationFailed => 'getLocationFailed'.tr;
  static String get amapKeyMissing => 'amapKeyMissing'.tr;

  static String get callDurationCaller => 'callDurationCaller'.tr;
  static String get callDurationCallee => 'callDurationCallee'.tr;
  ...
  static String get voiceCallConnecting => 'voiceCallConnecting'.tr;
  static String get voiceCallCalling => 'voiceCallCalling'.tr;
  static String get voiceCallIncoming => 'voiceCallIncoming'.tr;
  static String get voiceCallInProgress => 'voiceCallInProgress'.tr;
  static String get voiceCallEnded => 'voiceCallEnded'.tr;
  static String get voiceCallRestoring => 'voiceCallRestoring'.tr;
  static String get voiceCallPoorNetwork => 'voiceCallPoorNetwork'.tr;
  static String get voiceCallNetworkInterrupted =>
      'voiceCallNetworkInterrupted'.tr;
  static String get voiceCallMute => 'voiceCallMute'.tr;
  static String get voiceCallUnmute => 'voiceCallUnmute'.tr;
  static String get voiceCallSpeaker => 'voiceCallSpeaker'.tr;
  static String get voiceCallEarpiece => 'voiceCallEarpiece'.tr;
  static String get voiceCallLocalNetwork => 'voiceCallLocalNetwork'.tr;
  static String get voiceCallRemoteNetwork => 'voiceCallRemoteNetwork'.tr;
  static String get voiceCallNetworkGood => 'voiceCallNetworkGood'.tr;
  static String get voiceCallNetworkNormal => 'voiceCallNetworkNormal'.tr;
  static String get voiceCallNetworkPoor => 'voiceCallNetworkPoor'.tr;
  static String get voiceCallNetworkDetecting =>
      'voiceCallNetworkDetecting'.tr;
  ...
  static String get dataAbnormal => 'dataAbnormal'.tr;

  static String get messageCannotRevoke => 'messageCannotRevoke'.tr;
  ...
  static String get openWith => 'openWith'.tr;

  static String get selectMessages => 'selectMessages'.tr;
  static String get selectedMessageCount => 'selectedMessageCount'.tr;

  static String get revokeForAll => 'revokeForAll'.tr;
  ...
  static String get contactFriendEmpty => 'contactFriendEmpty'.tr;
  ...
  static String get clearingMessages => 'clearingMessages'.tr;

  static String get clearingCount => 'clearingCount'.tr;
  ...
  static String get groupSearchChatHistory => 'groupSearchChatHistory'.tr;
  static String get groupSearchEnterKeyword => 'groupSearchEnterKeyword'.tr;
  static String get groupSearchNoResult => 'groupSearchNoResult'.tr;
  static String get groupSearchResultWithKeyword =>
      'groupSearchResultWithKeyword'.tr;
  static String get groupSearchResultWithoutKeyword =>
      'groupSearchResultWithoutKeyword'.tr;
  static String get groupSearchDateFilter => 'groupSearchDateFilter'.tr;
  static String get groupSearchDateAll => 'groupSearchDateAll'.tr;
  ...
  static String get pleaseSelectMessage => 'pleaseSelectMessage'.tr;
  ...
  static String get busyLine => 'busyLine'.tr;
  ...
  static String get backgroundCallHint => 'backgroundCallHint'.tr;
  static String get backgroundCallWithName => 'backgroundCallWithName'.tr;
  ...
  static String get floatingWindowPermission =>
      'floatingWindowPermission'.tr;

  static String get floatingWindowPermissionHint =>
      'floatingWindowPermissionHint'.tr;

                ...
                _buildCornerBgView(
                  children: [
                    _buildItemView(
                      ...
                      onTap: logic.profileLocked ? null : logic.openPhotoSheet,
                      showRightArrow: !logic.profileLocked,
                    ),
                    _buildItemView(
                      label: StrRes.name,
                      value: imLogic.userInfo.value.nickname,
                      onTap: logic.profileLocked ? null : logic.editMyName,
                      showRightArrow: !logic.profileLocked,
                    ),
                    _buildItemView(
                      label: StrRes.gender,
                      value: imLogic.userInfo.value.isMale
                          ? StrRes.man
                          : StrRes.woman,
                      onTap: logic.profileLocked ? null : logic.selectGender,
                      showRightArrow: !logic.profileLocked,
                    ),
                    _buildItemView(
                      ...
                      onTap: logic.profileLocked ? null : logic.openDatePicker,
                      showRightArrow: !logic.profileLocked,
                    ),
                  ],
                ),
                ...
                _buildCornerBgView(
                  children: [
                    ...
                    _buildItemView(
                      ...
                      onTap: logic.profileLocked ? null : logic.editEmail,
                      showRightArrow: !logic.profileLocked,
                    ),
                  ],
                ),
